    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detour_paths', models.ManyToManyField(blank=True, null=True, to='api.DetourPath')),
                ('robots', models.ManyToManyField(blank=True, null=True, related_name='robotss', to='api.Robot')),
            ],
        ),
    ]
